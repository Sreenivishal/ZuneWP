# AGENTS.md - SimpMusic Project Guide for AI Agents
...
## 🔄 AGENTS.md Auto-Update Rule (MANDATORY)

After completing any of the following types of changes, the AI agent **MUST** update this AGENTS.md file:
