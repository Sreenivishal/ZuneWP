...
APK_OUTPUT_DIR="./app/build/outputs/apk/$BUILD_TYPE"
SIGNED_APK_OUTPUT_DIR="./app/build/outputs/apk/$BUILD_TYPE"
...
for APK_PATH in $APK_PATHS; do
  ...
  SIGNED_APK_PATH="$SIGNED_APK_OUTPUT_DIR/Zune-$BUILD_VARIANT-$(basename "$RELEASE_NAME")"
